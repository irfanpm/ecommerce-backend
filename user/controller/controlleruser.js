  ...
  product:async(req,res)=>{
   ...
   addcart:async(req,res)=>{
    ...
    for( x of req.body.product){
      ...
      await userSchema.updateOne({_id:req.params.id},{$push:{cart:x.id}})
    ...
    addwishlist:async(req,res)=>{
      ...
      for( x in prd){
        ...
        await userSchema.updateOne({_id:req.params.id},{$push:{wishlist:prd[x]}})
      ...
      wishlistview:async(req,res)=>{
        const user = await userSchema.find({_id:req.params.id}).populate("wishlist")
